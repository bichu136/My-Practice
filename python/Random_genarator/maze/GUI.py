...
#    Apr 02, 2020 08:21:24 PM +07  platform: Windows NT
...
class Toplevel:
    def __init__(self, top=None):
        ...
        top.geometry("600x450+587+219")
        top.minsize(148, 1)
        top.maxsize(1924, 1055)
        top.resizable(1, 1)
        top.title("Maze Generator")
        top.configure(background="#d9d9d9")
        top.configure(highlightbackground="#d9d9d9")
        top.configure(highlightcolor="black")

        self.BtnGenerate = tk.Button(top)
        self.BtnGenerate.place(relx=0.033, rely=0.689, height=43, width=126)
        ...
        self.BtnGenerate.configure(text='''Generate Maze''')
        self.BtnGenerate.configure(command = "print('hello')")
        self.Canvas1 = tk.Canvas(top)
        self.Canvas1.place(relx=0.017, rely=0.022, relheight=0.629
                , relwidth=0.955)
        ...
        self.Radiobutton1.place(relx=0.4, rely=0.667, relheight=0.069
                , relwidth=0.113)
        ...
        self.Radiobutton2.place(relx=0.4, rely=0.756, relheight=0.069
                , relwidth=0.113)
